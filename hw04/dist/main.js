...
function createRectModel(color) {
...
function vaoFromModel(model, shader) {
...
function create3DObject(model, transform, shader) {
    return {
        model,
        transform,
...
function renderObject(object, shader) {
...
function render(objects, shader) {
